...
START_TEST(sub_matrix_test_3) {
  ...
  expected_result.matrix[0][0] = 0, expected_result.matrix[0][1] = 1;
  expected_result.matrix[1][0] = 1, expected_result.matrix[1][1] = 1;
  expected_result.matrix[2][0] = 2, expected_result.matrix[2][1] = 2;
